...
const Projects = () => {
    ...
    useEffect(() => {
        const handleEscKey = (event) => {
            if (event.key === "Escape") {
            toggleTab(0); // Close modal by resetting toggle state
            }
        };
                ...
                <div className="projects-container container grid">
                    <div className="projects-content">
                        <div className="projects-icon">
                            ...
                            <h3 onClick={() => toggleTab(1)} className="projects-title">
                    ...
                    <div className="projects-content">
                        <div className="projects-icon">
                            ...
                            <h3 onClick={() => toggleTab(2)} className="projects-title">
                    ...
                    <div className="projects-content">
                        <div className="projects-icon">
                            ...
                            <h3 onClick={() => toggleTab(3)} className="projects-title">Personalized Skincare Strategies for High-Income Consumers</h3>
                        </div>
                    ...
                    <div className="projects-content">
                        <div className="projects-icon">
                            ...
                            <h3 onClick={() => toggleTab(4)} className="projects-title">
                    ...
                    <div className="projects-content">
                        <div className="projects-icon">
                            ...
                            <h3 onClick={() => toggleTab(5)} className="projects-title">
